									...
									<table class="table table-striped table-bordered">
										...
										<?php $no = 0 + (($this->uri->segment(4)!=null)?(($this->uri->segment(4)-1) * 30):0); $qt = 0; $di = 0; $gs = 0; $ns = 0; foreach($report as $row){ $no++; ?>
											<tr>
												...
												<td class="text-right"><?=number_format(($row['gross_sales']+0) - ($row['diskon_item']+0), 2)?></td>
		...
		<div class="modal-dialog modal-full">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-8">
							<div class="col-sm-4"><b>Kode Sales</b></div><div class="col-sm-8"><b> : </b><b id="kd_supp<?=$i?>"><?=$row['Kode']?></b></div>
							<div class="col-sm-4"><b>Nama Sales</b></div><div class="col-sm-8"><b> : </b><b><?=$row['Nama']?></b></div>
						</div>
						<div class="col-sm-4">
							<div class="row">
								<b><?=$periode?><b>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<table class="table table-striped table-bordered table-small">
								...
								$detail = $this->m_crud->read_data("Det_Trx dt, barang br, Master_Trx mt", "mt.kd_trx, mt.tgl, br.kd_brg, br.barcode, br.nm_brg, br.Deskripsi, dt.hrg_jual, dt.dis_persen, ".$qty.", ".$qty_retur, "mt.HR = 'S' AND mt.kd_trx=dt.kd_trx AND dt.kd_brg=br.kd_brg AND mt.kd_sales = '".$row['Kode']."' ".$q_tgl.$where."");
