		...
		<div class="modal-dialog modal-full">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-8">
							<div class="col-sm-4"><b>Kode Customer</b></div><div class="col-sm-8"><b> : </b><b id="kd_supp<?=$i?>"><?=$row['kd_cust']?></b></div>
							<div class="col-sm-4"><b>Nama Customer</b></div><div class="col-sm-8"><b> : </b><b><?=$row['Nama']?></b></div>
						</div>
						<div class="col-sm-4">
							<div class="row">
								<b><?=$periode?><b>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<table class="table table-striped table-bordered">
								...
								$detail = $this->m_crud->read_data("Det_Trx dt, barang br, Master_Trx mt", "mt.kd_trx, mt.tgl, br.kd_brg, br.barcode, br.nm_brg, br.Deskripsi, dt.hrg_jual, dt.dis_persen, ".$qty.", ".$qty_retur, "mt.HR = 'S' AND mt.kd_trx=dt.kd_trx AND dt.kd_brg=br.kd_brg AND mt.kd_cust = '".$row['kd_cust']."' ".$q_tgl.$where."");
								...
								$total_sub_total = $total_sub_total + (($rows['qty']-$rows['qty_retur'])*$rows['hrg_jual'])-$rows['diskon_item'];
								} ?>
								</tbody>
								<tfoot>
								<tr>
