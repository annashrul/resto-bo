...
<div>
	<div>
		<table width="100%" cellpadding="5" cellspacing="0" style="border:1px solid black; font-size:11px;">
            ...
            <?php
            $no = 0;
            $jbeli = 0; $jjual = 0; $sa = 0; $sp = 0; $st = 0; $jl = 0; $rt = 0; $di = 0;
            ...
            <tr>
                ...
                <td style="border:1px solid black"><?=($rows['stock_awal']+$rows['stock_masuk']-$rows['jual']-$rows['retur']+0)?></td>
                <td style="border:1px solid black"><?=($rows['jual']+0)?></td>
                <td style="border:1px solid black"><?=($rows['retur']+0)?></td>
                <td style="border:1px solid black"><?=$rows['satuan']?></td>
