												...
												<td class="text-center">
													<div class="btn-group">
														...
														<ul class="dropdown-menu" role="menu">
															...
															<?php } ?>
                                                            <li><a href="#" onclick="re_print('<?=$row['no_po']?>', cetak_pdf)"><i class="md md-print"></i> to PDF</a></li>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<table id="datatable" class="table table-striped table-bordered">
								...
								<tbody>
								<?php $no = 0;
								$detail = $this->m_crud->join_data('Detail_PO dp', 'dp.kode_barang, br.barcode, br.nm_brg, dp.jumlah_beli, dp.harga_beli, dp.harga_jual, br.satuan, br.deskripsi', 'barang as br', 'dp.kode_barang = br.kd_brg', "dp.no_po = '".$row['no_po']."'");
...
<script>
	function delete_trans(kode) {
		if (confirm('Akan menghapus data?')) {
			var table_ = ['Master_PO', 'Detail_PO'];
			var condition_ = ['no_po=\''+kode+'\'','no_po=\''+kode+'\''];
			
			hapus_otorisasi({param:'', kode:btoa(kode), activity:'Hapus Purchase Order', table:table_, condition:condition_}, delete_transaksi);
		}
	}
