								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<div class="input-group">
											<div class="input-group-btn">
												<?php $field = 'pelunasan';
												$option = null;$option[''] = 'Semua Status Pelunasan';
												$option['Lunas'] = 'Lunas';
												$option['Belum Lunas'] = 'Belum Lunas';
										...
										<table class="table table-striped table-bordered">
											...
											foreach($report as $row){
												...
												<tr>
													...
													<td class="text-center">
														<div class="btn-group">
															...
															<ul class="dropdown-menu" role="menu">
																...
																<?php if($row['type']=='Kredit' && $row['Pelunasan']=='Belum Lunas'){ ?><li><a href="<?=base_url().'pembelian/bayar_hutang/bayar_nota_beli/'.base64_encode($row['no_faktur_beli'])?>" target="_blank"><i class="md md-payment"></i> Bayar Hutang</a></li><?php } ?>
																<!--<li class="divider"></li>-->
															</ul>
														</div>
													</td>
													...
													<td><?=$row['type']?></td>
													<td>
														<?php if($row['Pelunasan']=='Belum Lunas'){?>
															<span class="btn btn-danger btn-sm">Belum Lunas</span>
														<?php }else{?>
															<span class="btn btn-info btn-sm">Lunas</span>
														<?php } ?>
													</td>
													<td><?=$row['supplier']?></td>
													<td><?=$row['lokasi']?></td>
