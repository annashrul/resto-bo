                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th class="font_head" rowspan="2">Rasio</th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="font_head"><?=(float)$detail['qty_stock']?></th>
                                                <th class="text-right font_head"><?=number_format((float)$detail['value_stock'], 2)?></th>
                                                <th class="font_head"><?=(float)$detail['qty_beli']?></th>
                                                <th class="text-right font_head"><?=number_format((float)$detail['total_pembelian'], 2)?></th>
                                                <th class="font_head"><?=(float)$detail['qty_jual']?></th>
                                                <th class="text-right font_head"><?=number_format((float)$detail['value_beli'], 2)?></th>
                                                <th class="text-right font_head"><?=number_format((float)$detail['value_jual'], 2)?></th>
                                                <th class="text-right font_head"><?=number_format($detail['value_jual']-$detail['value_beli'], 2)?></th>
                                                <th class="font_head"><?=($detail['value_beli']>0 && $detail['value_beli']<$detail['value_jual'])?round((($detail['value_jual']-$detail['value_beli']) / $detail['value_beli'])*100, 2):'0'?></th>
                                                <th></th>
                                                <th></th>
                                            </tr>
                                            <!--<tr>
