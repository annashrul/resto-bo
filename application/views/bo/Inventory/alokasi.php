                                        ...
                                        <form id="form_head">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row" style="margin-bottom: 3px">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="lokasi_tujuan" id="lokasi_tujuan" onchange="get_data_pembelian(); update_tmp_master('m4', $(this).val()); hide_notif('alr_lokasi_tujuan'); hide_notif('alr_lokasi_asal'); check_lokasi();" class="select2">
                                                                <option value="">Pilih</option>
                                                                <?php
                                                                foreach ($data_lokasi_tujuan as $row) {
                                                                    echo "<option value=\"".$row['Kode']."|".$row['serial']."\">".$row['Nama']."</option>";
                                                                }
                                                                ?>
                                                            </select>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="row" style="margin-bottom: 3px">
                                                        <label class="col-sm-4">Delivery Note</label>
                                                        <div class="col-sm-7">
...
<script>
    ...
    function add_data_pembelian() {
        ...
        if (kode_pembelian != '') {
            $.ajax({
                url: "<?php echo base_url() . 'inventory/add_data_pembelian/' ?>" + btoa('add'),
                type: "GET",
                dataType: "JSON",
    ...
    function clear_list(param=0) {
        if (param==1) {
            $.ajax({
                url: "<?php echo base_url() . 'inventory/delete_tmp_d/' ?>",
                type: "GET",
    ...
    function update_tmp_master(column, value, trx='') {
        ...
        if (trx != '') {
            $.ajax({
                url: "<?php echo base_url() . 'inventory/update_tr_temp_m/' ?>" + btoa(trx) + "/" + btoa(column) + "/" + btoa(value),
                type: "GET"
            });
        }
    }
    ...
    function add_barang() {
        ...
        $.ajax({
            ...
            data: {no_mutasi_: no_mutasi, list_: list, param:'add'},
            type: "POST",
            success: function (data) {
                if (data) {
                    get_tmp_detail();
    ...
    $("#barcode").keyup(function (event) {
        ...
        if (event.keyCode == 13) {
            ...
            if (kode_pembelian != '-') {
                //$("#alr_barang").text("Alokasi By Delivery Note!");
            }

            if (lokasi_asal != '' /*&& kode_pembelian == '-'*/) {
                $.ajax({
                    url: "<?php echo base_url() . 'inventory/get_barang/' ?>" + btoa(no_mutasi) + "/" + btoa(barcode) + "/" + btoa(lokasi_asal) + "/" + btoa(cat_cari) + "/" + btoa('add'),
                    type: "GET",
                    dataType: "JSON",
                    success: function (data) {
                        /*if (data.status == 1) {
    ...
    function trx_number() {
		...
		var set_focus = 1;
		if(document.getElementById("set_focus_qty").checked == true){
			set_focus = 2;
		}
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            setTimeout(function () {
                                ...
                                update_tmp_master('m11', set_focus, data);
                            }, 500);
                        }
                    });
                } else {
				...
				$.ajax({
					...
					success: function (data) {
						if (data.status) {
                            ...
                            cetak_transaksi(data.pdf, data.print, data.kode);
						} else {
