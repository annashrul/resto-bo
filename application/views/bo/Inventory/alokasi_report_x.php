													...
													<td class="text-center">
														<div class="btn-group">
															...
															<ul class="dropdown-menu" role="menu">
																...
																<li><a href="<?=base_url().strtolower($this->control).'/'.$page.'/download/'.base64_encode($row['no_faktur_mutasi'])?>"><i class="md md-get-app"></i> Download</a></li>
																<li><a href="<?=base_url().strtolower($this->control).'/'.$page.'/print/'.base64_encode($row['no_faktur_mutasi'])?>" target="_blank"><i class="md md-print"></i> to PDF</a></li>
																<li><a href="#" onclick="printDiv('print_alokasi<?=$no?>')"><i class="md md-print"></i> Print</a></li>
...
<div id="print_alokasi<?=$i?>" class="hidden print-nota">
    <table width="100%" cellspacing="0" cellpadding="1" style="letter-spacing: 5px; font-family: 'Courier New'; margin-bottom: 10px; font-size: 9pt">
        <thead>
        <tr>
            <td colspan="8" class="text-center">Alokasi Barang (<?=$row['no_faktur_mutasi']?>)</td>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            ...
            <td>Status</td>
            <td>:</td>
            <td><?php if($row['status']=='0'){echo "Packing";}else if($row['status']=='1'){echo "Packed";}else{echo "Received";}?></td>
        </tr>
        </tbody>
    </table>
    ...
    <table width="100%" style="letter-spacing: 5px; font-family: 'Courier New'; font-size:9pt;">
        ...
        <tbody>
        <?php $no = 0; $total = 0;
        $detail = $this->m_crud->join_data('Det_Mutasi as dm', 'br.kd_brg, br.barcode, br.nm_brg, dm.qty, dm.hrg_jual', 'barang as br', 'br.kd_brg = dm.kd_brg', "dm.no_faktur_mutasi = '".$row['no_faktur_mutasi']."'");
