...
<script>
    ...
    function get_tmp_master() {
        $.ajax({
            url: "<?php echo base_url() . 'inventory/get_tr_temp_m_packing' ?>",
            type: "GET",
            dataType: "JSON",
    ...
    function get_tmp_detail(param=0, col=0) {
        $.ajax({
            url: "<?php echo base_url() . 'inventory/get_tr_temp_d_packing' ?>",
            type: "GET",
            dataType: "JSON",
            success: function (data) {
    ...
    function update_tmp_detail(barcode, column, value) {
        $.ajax({
            url: "<?php echo base_url() . 'inventory/update_tr_temp_d_packing/' ?>" + btoa(barcode) + "/" + btoa(column) + "/" + btoa(value) + "/" + btoa('add'),
            type: "GET"
        });
    }
    ...
    function hapus_barang(barcode) {
        $.ajax({
            url: "<?php echo base_url() . 'inventory/delete_tr_temp_d_packing/' ?>" + btoa(barcode) + "/" + btoa('add'),
            type: "GET",
            success: function (data) {
                if (data) {
                    get_tmp_detail();
    ...
    function cari_barang() {
        ...
        if (no_faktur_mutasi != '-') {
            $.ajax({
                ...
                data: {no_faktur_mutasi_: no_faktur_mutasi, param_: 'add'},
                type: "POST",
                dataType: "JSON",
                success: function (data) {
    ...
    function add_barang() {
        ...
        $.ajax({
            ...
            data: {kd_packing_: kd_packing, no_faktur_mutasi_:no_faktur_mutasi, list_: list, param_: 'add'},
            type: "POST",
            success: function (data) {
                if (data) {
                    get_tmp_detail();
    ...
    $("#barcode").keyup(function (event) {
        ...
        if (event.keyCode == 13) {
            ...
            if (no_faktur_mutasi != '') {
                $.ajax({
                    url: "<?php echo base_url() . 'inventory/get_barang_packing/' ?>" + btoa(kd_packing) + "/" + btoa(no_faktur_mutasi) + "/" + btoa(barcode) + "/" + btoa(cat_cari),
                    type: "GET",
                    dataType: "JSON",
                    success: function (data) {
						if (data.status == 1) {
    ...
    function batal_transaksi() {
        $.ajax({
            url: "<?php echo base_url().'inventory/delete_trans_packing/' ?>" + btoa('add'),
            type: "GET",
            success: function (data) {
                location.reload();
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status == 1) {
                            ...
                            cetak_transaksi('packing_report', 'packing', data.kd_packing, 'packing');
                        } else {
