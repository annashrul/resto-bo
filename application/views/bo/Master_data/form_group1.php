						...
						<div class="panel-body">
							...
							<?= isset($_GET['trx'])?'<input type="hidden" name="update" value="1" />':''; ?>
								<div class="form-group " style="margin-bottom:5px;">
									<label for="cemail" class="control-label col-lg-2">Kode</label>
									<div class="col-lg-10">
										<?php $field = 'Kode'; ?>
										<input class="form-control" type="text" onblur="cek_data('<?=$table?>','<?=$field?>', 'error', 'Kode sudah digunakan!')" id="<?=$field?>" name="<?=$field?>" value="<?=isset($master_data[$field])?$master_data[$field]:set_value($field)?>" required aria-required="true" />
