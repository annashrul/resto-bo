								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div>
										<table id="" class="table table-striped table-bordered">
											<thead>
												<tr>
													<th>No</th><th>Action</th><th>Kode</th><th>Nama</th><!--<th>Margin</th>--><th>Status</th><th>Gambar</th>
												</tr>
											</thead>
											<tbody>
											<?php $no = 0 + (($this->uri->segment(4)!=null)?(($this->uri->segment(4)-1) * 50):0); foreach($master_data as $row){ $no++; ?>
												<tr>
													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu" role="menu">
																<li><div class="col-sm-12"><?=anchor($content.'/edit/?trx='.base64_encode($row['id_fasilitas']), '<i class="fa fa-edit"></i> Edit', array('class'=>'btn btn-default col-sm-12'))?></div></li>
																<li><div class="col-sm-12"><button class="btn btn-default col-sm-12" onclick="hapus('<?=$table?>', '<?='id_fasilitas'?>', '<?=base64_encode($row['id_fasilitas'])?>')"><i class="fa fa-trash"></i> Delete</button></div></li>
															</ul>
														</div>
													</td>
													...
													<td><img width="80px" src="<?=base_url().$row['gambar']?>" /></td>
												</tr>
											<?php } ?>
											</tbody>
										</table>
