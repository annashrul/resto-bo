							...
							<?= isset($_GET['trx'])?'<input type="hidden" name="update" value="1" />':''; ?>
								...
								<div class="form-group " style="margin-bottom:5px;">
									...
									<div class="col-lg-10">
										...
										*/ ?>
										<input class="form-control autocomplete_data" type="text" name="<?=$field?>" value="<?=isset($master_data[$field])?$master_data[$field]:set_value($field)?>" required aria-required="true" />	
								...
								<div class="form-group " style="margin-bottom:5px;">
									...
									<div class="col-lg-10">
										...
										<input class="form-control" type="number" step="any" name="<?=$field?>" value="<?=(isset($master_data[$field])?(float)$master_data[$field]:set_value($field))?>" required aria-required="true" />
										<?=form_error($field, '<div class="error" style="color:red;">', '</div>')?>
									</div>
								</div>
								<div class="form-group " style="margin-bottom:5px;">
									<label for="cemail" class="control-label col-lg-2">Diskon</label>
									<div class="col-lg-10">
										<?php $field = 'disc1'; ?>
										<input class="form-control" type="number" step="any" name="<?=$field?>" value="<?=(isset($master_data[$field])?(float)$master_data[$field]:set_value($field))?>" required aria-required="true" />
										<?=form_error($field, '<div class="error" style="color:red;">', '</div>')?>
								...
								<div class="form-group ">
									<label for="cemail" class="control-label col-lg-2">PPN</label>
									<div class="col-lg-10">
										<?php $field = 'ppn'; ?>
										<input class="form-control" type="number" step="any" name="<?=$field?>" value="<?=(isset($master_data[$field])?(float)$master_data[$field]:set_value($field))?>" required aria-required="true" />
										<?=form_error($field, '<div class="error" style="color:red;">', '</div>')?>
