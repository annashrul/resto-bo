								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="table-wrapper">
										<table class="table table-striped table-bordered">
											<thead>
												<tr>
													<th>No</th><th>Action</th><th>Status</th><th>Kode</th><th>Company</th><th>Nama</th><th>Alamat</th><th>Telp</th><!--<th>Ket</th><th>Balance</th>-->
												</tr>
											</thead>
											<tbody>
													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu" role="menu">
																<li><div class="col-sm-12"><?=anchor($content.'/edit/?trx='.base64_encode($row['compliment_id']), '<i class="fa fa-edit"></i> Edit', array('class'=>'btn btn-default col-sm-12'))?></div></li>
																<li><div class="col-sm-12"><button class="btn btn-default col-sm-12" onclick="hapus('<?=$table?>', '<?='compliment_id'?>', '<?=$row['compliment_id']?>')"><i class="fa fa-trash"></i> Delete</button></div></li>
															</ul>
														</div>
													</td>
													<td style="text-align: center"><img width="25px" src="<?=base_url().'assets/images/status-'.($row['status']==1?'Y':'T').'.png'?>" /></td>
													<td><?=$row['compliment_id']?></td>
													<td><?=$row['company']?></td>
													<td><?=$row['nama']?></td>
													<td><?=$row['alamat']?></td>
													<td><?=$row['tlp']?></td>
