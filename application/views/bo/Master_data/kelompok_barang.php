				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<?php $as_group = $this->m_crud->get_data('Setting', 'as_group2', "Kode = '1111'"); ?>
							<?= form_open($content); ?>
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											...
											<div class="input-group">
												<div class="input-group-btn">
													...
													$option = null;
													$option['kel_brg'] = 'Kode';
													$option['nm_kel_brg'] = 'Nama';
													//$option['margin'] = 'Margin';
													$option['Nama'] = $as_group['as_group2'];
										...
										<div class="form-group">
											...
											<div class="input-group">
												<div class="input-group-btn">
													...
													$option['nm_kel_brg'] = 'Nama';
													//$option['margin'] = 'Margin';
													$option['Nama'] = $as_group['as_group2'];//$data_option = $this->m_crud->read_data('Group2', 'Kode, Nama', null, 'Nama asc');
													//foreach($data_option as $row){ $option[$row['Kode']] = $row['Nama']; }
													echo form_dropdown($field, $option, isset($this->session->search[$field])?$this->session->search[$field]:set_value($field), array('class' => 'select2', 'id'=>$field, 'required'=>'required')); 
													?>
												</div>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div>
										<table id="" class="table table-striped table-bordered">
											<thead>
												<tr>
													<th>No</th><th>Action</th><th>Kode</th><th>Nama</th><!--<th>Margin</th>--><th>Status</th><th><?=$as_group['as_group2'];?></th>
												</tr>
											</thead>
											<tbody>
													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu" role="menu">
																<li><div class="col-sm-12"><?=anchor($content.'/edit/?trx='.base64_encode($row['kel_brg']), '<i class="fa fa-edit"></i> Edit', array('class'=>'btn btn-default col-sm-12'))?></div></li>
																<!--<li class="divider"></li>-->
																...
																<li><div class="col-sm-12"><button class="btn btn-default col-sm-12" onclick="hapus('<?=$table?>', '<?='kel_brg'?>', '<?=base64_encode($row['kel_brg'])?>')"><i class="fa fa-trash"></i> Delete</button></div></li>
															</ul>
														</div>
													</td>
													<td><?=$row['kel_brg']?></td>
