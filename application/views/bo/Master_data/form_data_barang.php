                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-4">
                                <?php $field = 'kd_brg'; ?>
                                <input type="hidden" name="<?=$field?>" id="<?=$field?>" value="<?=set_value($field)?set_value($field):(isset($master_data[$field])?$master_data[$field]:null)?>">
                                ...
                                <!--<div class="form-group " style="margin-bottom:5px;">
									...
									<div class="col-lg-8">
										<?php /*$field = 'Deskripsi'; */?>
										<input class="form-control" type="text" maxlength="30" id="<?/*=$field*/?>" name="<?/*=$field*/?>" value="<?/*=set_value($field)?set_value($field):(isset($master_data[$field])?$master_data[$field]:null)*/?>" required aria-required="true" />
										<?/*=form_error($field, '<div class="error" style="color:red;">', '</div>')*/?>
                                        <b class="error" id="ntf_<?/*=$field*/?>"></b>
                                        <input type="hidden" id="param_<?/*=$field*/?>" value="0">
                                        <input type="hidden" id="temp_<?/*=$field*/?>" value="<?/*=set_value($field)?set_value($field):(isset($master_data[$field])?$master_data[$field]:null)*/?>">
                                ...
                                <div class="form-group " style="margin-bottom:5px;">
                                    <label class="control-label col-lg-4">Berat (Gr)</label>
                                    <div class="col-lg-8">
                                        <?php $field = 'berat'; ?>
                                        <input class="form-control" type="number" step="any" id="<?=$field?>" name="<?=$field?>" value="<?=set_value($field)?set_value($field):(isset($master_data[$field])?($master_data[$field]+0):null)?>" required aria-required="true" />
                                        <?=form_error($field, '<div class="error" style="color:red;">', '</div>')?>
                                ...
                                <div class="row" style="margin-bottom:10px;">
                                    <label class="col-sm-4 control-label text-left">Deskripsi</label>
                                    <div class="col-sm-8">
                                        <?php
                                        $field = 'Deskripsi';
                                        ?>
                                        <textarea name="<?=$field?>" id="<?=$field?>" class="form-control" rows="4"><?=set_value($field)?set_value($field):(isset($master_data[$field])?$master_data[$field]:null)?></textarea>
                                ...
                                <div class="form-group " style="margin-bottom:5px;display: <?=isset($_GET['trx'])?"none":"block"?>" id="container_bahan">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        foreach($data_option as $row){ $option[$row['kd_brg']] = $row['nm_brg']; }
                                        echo form_multiselect($field, $option, $array_bahan, array('class' => 'select2', 'id'=>'bahan'));
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group " style="margin-bottom:5px;">
                                    <label class="control-label col-lg-4">Poin</label>
                                    <div class="col-lg-8">
                                        <?php $field = 'poin';
                                        $option = null;
                                        $option[0] = 'Tidak Dihitung Poin';
                                        $option[1] = 'Dihitung Poin';
                                ...
                                <div class="form-group " style="margin-bottom:5px;" id="container_kcp">
                                    ...
                                    <div class="col-lg-8">
                                        <?php
                                        $get_printer = $this->m_crud->read_data("kitchen_printer", "id_printer, nama");
                                        $field = 'kcp';
                                        $option = null;
                                        $option[''] = 'Tidak di Print';
                                        if (count($get_printer) > 0) {
                                            foreach ($get_printer as $item) {
                                                $option[$item['id_printer']] = $item['nama'];
                                            }
                                        }
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="tab-content" style="max-height: 480px; overflow: auto; overflow-x: hidden;">
                                    <div class="tab-pane active" id="lokasi-harga">
                                        <div class="form-group " style="margin-bottom:5px;">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="control-label"><p style="text-align:center;">Service %</p></label>
                                                    </div>
                                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group " style="margin-bottom:5px;">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="col-md-3">
                                                        <?php $field = 'master_service'; ?>
                                                        <input class="form-control" type="number" step="any" onclick="$(this).select()" id="<?=$field?>" name="<?=$field?>" value="<?=set_value($field)?set_value($field):(isset($master_data['service'])?($master_data['service']+0):null)?>" />
                                                        <?=form_error($field, '<div class="error" style="color:red;">', '</div>')?>
                                                    </div>
                                                    <div class="col-md-3">
                                        ...
                                        <?php
                                        $lokasi = $this->m_crud->read_data('Lokasi', 'Kode, Nama', "kode in (".$this->lokasi_in.")", 'Nama asc');
                                        foreach($lokasi as $key => $rows){
                                            $no = $key+1;
                                            if(isset($_GET['trx'])){
                                                foreach($master_data_detail as $row){
                                                    if($row['lokasi']==$rows['Kode']){
                                                        ...
                                                        $master_data['service'.$no] = $row['service'];
