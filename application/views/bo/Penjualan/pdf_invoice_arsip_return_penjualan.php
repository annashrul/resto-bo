	...
	<div>
		<table width="100%" cellpadding="5" cellspacing="0" style="border:1px solid black; font-size:11px;">
			...
			<tr>
				...
				<th style="border:1px solid black">Kelompok Barang</th>
				...
				<th style="border:1px solid black">Nilai Retur</th>
			</tr>
			</thead>
			<tbody>
			<?php $i=0; $total = 0; foreach($report_detail as $row){
				$i++;
				$sub_total = ($row['qty'] * $row['hrg_jual'] * -1) - $row['dis_persen'];
				...
				<tr>
					...
					<td style="border:1px solid black"><?=$row['nm_kel_brg']?></td>
					<td style="border:1px solid black"><?=$row['qty'] * -1 + 0?></td>
