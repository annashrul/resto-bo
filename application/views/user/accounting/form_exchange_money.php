				...
				<div class="col-sm-12">
					<div class="col-sm-12">
						<div class="row" style="margin-bottom:10px;">
							...
							<div class="col-sm-8">
								<input class="form-control" type="text" name="nama" value="<?=isset($kurs['nama'])?$kurs['nama']:set_value('nama')?>" required />	
								<?=form_error('nama', '<div class="error" style="color:red;">', '</div>')?>
							</div> 
						</div>
						<div class="row" style="margin-bottom:10px;">
							<label class="col-sm-4 control-label text-left">Rate</label>
							<div class="col-sm-8">
								<input class="form-control" type="number" step="any" name="rate" value="<?=isset($kurs['rate'])?$kurs['rate']:set_value('rate')?>" required />	
								<?=form_error('rate', '<div class="error" style="color:red;">', '</div>')?>
							</div> 
						</div>
					</div> 
				</div>
