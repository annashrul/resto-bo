...
<section class="invoice">
	...
	<div class="box-body">
		...
		<div class="row">
			<div class="col-sm-12">
				<h3 class="text-center" style="margin-top: 1px;"><b>Journal Entry</b></h3>
			</div>
		</div>
		<div class="row col-sm-9" style="margin-bottom: 10px;">
			<label>Journal Entry No. : </label> <?=$print['id_journal_entry']?><br/>
				...
				<div class="box">
					<div class="box-body table-responsive">
						<table id="" class="table table-striped dataTable">
							...
							$detail = $this->m_crud->read_data('acc_general_journal', '*', "id_trx = '".$print['id_journal_entry']."'", 'tanggal desc, id_general_journal asc');
