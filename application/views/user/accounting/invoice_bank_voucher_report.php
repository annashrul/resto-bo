...
<section class="invoice">
	...
	<div class="box-body">
		...
		<div class="row col-sm-7" style="margin-bottom: 10px;">
			<label>Voucher No. : </label> <?=$print['id_bank_voucher']?><br/>
				...
				<div class="box">
					<div class="box-body table-responsive">
						<table id="" class="table table-striped dataTable">
							...
							$detail = $this->m_crud->read_data('acc_general_journal', '*', "id_trx = '".$print['id_bank_voucher']."' and coa <> '".$print['coa']."'", 'tanggal desc, id_general_journal asc');
