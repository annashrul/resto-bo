...
<section class="invoice">
	...
	<div class="box-body">
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					<div class="col-sm-8">
						<?=$this->m_gracia->logo()?><br>
						<span><?=$this->m_gracia->address()?></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row col-sm-7" style="margin-bottom: 10px;">
			<label>Voucher No. : </label> <?=$print['id_tico_voucher']?><br/>
		...
		<div class="row col-sm-5 pull-right" style="margin-bottom: 10px;">
			<label>Currency : </label> <?=$this->m_gracia->kurs($print['currency'], 'nama')?><br/>
			...
			<label>Penerima : </label> <?=$this->m_gracia->user_data($print['user_id'])->nama?><br/>
		</div>
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body table-responsive">
						<table id="" class="table table-striped dataTable">
							...
							$detail = $this->m_crud->read_data('acc_general_journal', '*', 'id_trx = "'.$print['id_tico_voucher'].'" and coa <> "'.$print['coa'].'"', 'tanggal desc, id_general_journal asc');
			...
			<div class="col-sm-12" style="margin-top: 10px;">
				<div class="col-sm-5 text-center">
					<div class="col-sm-6 text-center">
						<label class="control-label text-center"></label><br/>
						<label class="control-label text-center">Disiapkan Oleh</label><br/><br/><br/>
						<?=$this->m_gracia->user_data($print['user_id'])->nama?>
					</div>
					<div class="col-sm-6 text-center">
						<label class="control-label text-center"></label><br/>
						<label class="control-label text-center">Diperiksa Oleh</label><br/><br/><br/>
					</div>
				</div>
				<div class="col-sm-2 text-center">
					<label class="control-label text-center"></label><br/>
					<label class="control-label text-center">Disetujui Oleh</label><br/><br/><br/>
				</div>
				<div class="col-sm-5 text-center">
					<div class="col-sm-6 text-center">
						<label class="control-label text-center"></label><br/>
						<label class="control-label text-center">Dibayar Oleh</label><br/><br/><br/>
					</div>
					<div class="col-sm-6 text-center">
						<label class="control-label text-center"></label><br/>
						<label class="control-label text-center">Diterima Oleh</label><br/><br/><br/>
					</div>
				</div>
			</div>
		</div>
