    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
				<?php if (substr($access->access,14,1) == 1 ){ ?><button type="button" data-toggle="modal" data-target="#trx" class="btn btn-primary">Transaction Report</button><?php } ?>
				...
				<div class="col-sm-12">
					<div class="col-sm-7">
						<div class="col-sm-12" style="margin-bottom: 5px;">
							<div class="col-sm-4"><label>Bank Voucher No.</label></div>
							<div class="col-sm-6">
								<input class="form-control" type="text" name="id_cv" id="id_cv" value="<?=set_value('id_cv')?>" readonly />
						...
						<div class="col-xs-12">
							<div class="box-body table-responsive">
								<table id="example" class="table table-bordered table-striped dataTable">
									<thead>
										<tr>
											<th>No</th><th>bank Voucher No.</th><th>Date</th><th>Account</th><th>Description</th><th>Total</th><th>Action</th>
										</tr>
									</thead>
									<tbody>
										...
										$i = 0; $transaction = $this->m_crud->read_data($table, '*, (select sum(debit) from acc_general_journal where id_trx = id_bank_voucher) as total', $where, 'tanggal desc');
...
function trx_number(){
	var table = '<?=$table?>';
	var column = 'id_bank_voucher';
	var trx = '<?=$this->m_website->lokasi(null,'serial')?>-BVO';
